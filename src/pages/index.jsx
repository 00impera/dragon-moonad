...
function DragonParticles() {
  ...
  for (var i = 0; i < 30; i++) {
    items.push(
      <div key={i} className={"dp dp" + (i % 3)} style={{
        left: ((i * 37 + 5) % 100) + "%",
...
function BuyWithCard({ account, sym }) {
  ...
  return (
    <div style={{ marginTop: 12 }}>
      {!show ? (
        <button className="btn-fire" onClick={() => { vibrate(); setShow(true); }}>
          💳 BUY {sym} WITH CARD
        </button>
      ) : (
        <>
    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .dp0 { width: 6px;  height: 14px; background: radial-gradient(var(--fire),  transparent); opacity: 0.7; }
        .dp1 { width: 4px;  height: 9px;  background: radial-gradient(var(--fire2), transparent); opacity: 0.5; }
        .dp2 { width: 2px;  height: 5px;  background: radial-gradient(var(--fire3), transparent); opacity: 0.35; }
        @keyframes fireRise {
        ...
        .tab-btn:active { animation: tabVibrate 0.28s ease; }
        @keyframes tabVibrate {
        ...
        .btn-fire:active:not(:disabled) { transform: scale(0.97); animation: btnVibrate 0.3s ease, fireShift 3s ease infinite; }
        ...
        .btn-gold:active:not(:disabled) { animation: btnVibrate 0.3s ease; transform: scale(0.97); }
        ...
        .btn-outline:active { animation: btnVibrate 0.3s ease; }
      ...
      <div className="app">
        ...
        <header className="header">
          <div className="logo">
            <img src={COIN_LOGO} alt="Dragon Coin" onError={function(e){ e.target.style.display='none'; }} />
            <div>
        ...
        <section className="hero">
          <div className="hero-logo">
            <img src={COIN_LOGO} alt="Dragon" onError={function(e){ e.target.style.display='none'; }} />
          </div>
          ...
          {[
            ...
            return (
              <button
                ...
                onClick={function(){ vibrate(); setTab(t.id); }}
              >
                {t.label}
              </button>
            );
