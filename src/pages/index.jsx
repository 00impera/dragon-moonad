  ...
  return (
    <svg width={s} height={s} viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg"
      style={{ borderRadius: "50%", flexShrink: 0,
        ...
        boxShadow: s > 80 ? "0 0 40px rgba(0,200,255,0.7),0 0 80px rgba(0,100,255,0.3)" : "0 0 16px rgba(0,200,255,0.7)",
      }}>
      <defs>
        <radialGradient id={"dg1"+s} cx="40%" cy="35%" r="65%">
          <stop offset="0%"   stopColor="#00eaff"/><stop offset="50%" stopColor="#0066ff"/><stop offset="100%" stopColor="#003080"/>
        </radialGradient>
        <radialGradient id={"dg2"+s} cx="50%" cy="50%" r="50%">
          <stop offset="0%"   stopColor="#00ffea" stopOpacity="0.9"/><stop offset="100%" stopColor="#0066ff" stopOpacity="0.2"/>
        </radialGradient>
      </defs>
  ...
  return (
    <img src={COIN_LOGO} alt="Dragon" width={s} height={s}
      style={{ borderRadius:"50%", flexShrink:0, display:"block", objectFit:"cover",
        border: s > 80 ? "3px solid #00c8ff" : "2px solid #00c8ff",
        boxShadow: s > 80 ? "0 0 40px rgba(0,200,255,0.7),0 0 80px rgba(0,100,255,0.3)" : "0 0 16px rgba(0,200,255,0.6)",
      }}
...
function BuyWithCard({ account, sym }) {
  ...
  return (
    <div style={{ marginTop:12 }}>
      {!show
        ? <button className="btn-neon" onClick={function(){ vibrate(); setShow(true); }}>💳 BUY {sym} WITH CARD</button>
        : <>
...
function BottomBanner() {
  ...
  const socialLinks = [
    {
      ...
      icon:  <svg width="18" height="18" viewBox="0 0 24 24" fill="none"><path d="M21.8 2.15L1.5 9.9c-1.3.5-1.3 1.2-.2 1.5l5.2 1.6 12-7.6c.6-.4 1.1-.2.7.2L8.3 15.5v3.7c0 .8.4 1 .9.5l2.5-2.4 5.1 3.8c.9.5 1.6.2 1.8-.9L22.8 3.4c.3-1.3-.5-1.9-1-1.25z" fill="#00c8ff"/></svg>,
      label: "TELEGRAM",
      sub:   "DragonMonadBot",
      color: "#00c8ff",
    },
    {
      ...
      icon:  <svg width="16" height="16" viewBox="0 0 24 24" fill="#a78bfa"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>,
      label: "TWITTER",
      sub:   "@bnbgold277983",
      color: "#a78bfa",
    },
    ...
    {
      href:  MONAD_VISION,
      icon:  <svg width="17" height="17" viewBox="0 0 24 24" fill="none"><path d="M2 12C2 12 6 5 12 5s10 7 10 7-4 7-10 7S2 12 2 12z" stroke="#00ffcc" strokeWidth="1.8"/><circle cx="12" cy="12" r="3" fill="#00ffcc" opacity="0.7"/></svg>,
      label: "ANALYTICS",
      sub:   "MonadVision",
      color: "#00ffcc",
    },
  ...
  return (
    <div style={{ position:"relative", zIndex:5, padding:"0 16px 28px" }}>
      ...
      <div style={{
        border:"1px solid rgba(0,200,255,0.28)", borderTop:"none",
        borderRadius:"0 0 16px 16px", overflow:"hidden",
        background:"linear-gradient(160deg,#00060f 0%,#000d1f 60%,#001230 100%)",
        boxShadow:"0 0 48px rgba(0,200,255,0.08),0 0 80px rgba(0,100,255,0.04)",
      }}>
        ...
        <a href={MONAD_VISION} target="_blank" rel="noopener noreferrer"
          style={{
            ...
            background:"linear-gradient(90deg,rgba(245,158,11,0.06) 0%,rgba(0,200,255,0.09) 50%,rgba(167,139,250,0.06) 100%)",
            borderBottom:"1px solid rgba(0,200,255,0.15)",
            cursor:"pointer", transition:"background 0.2s",
          }}
          onMouseOver={function(e){ e.currentTarget.style.background="linear-gradient(90deg,rgba(245,158,11,0.14) 0%,rgba(0,200,255,0.18) 50%,rgba(167,139,250,0.14) 100%)"; }}
          onMouseOut= {function(e){ e.currentTarget.style.background="linear-gradient(90deg,rgba(245,158,11,0.06) 0%,rgba(0,200,255,0.09) 50%,rgba(167,139,250,0.06) 100%)"; }}
        >
          {/* Dragon logo */}
          <div style={{ position:"relative", flexShrink:0 }}>
            <img src={COIN_LOGO} alt="DRAGON"
              style={{
                ...
                boxShadow:"0 0 18px rgba(0,200,255,0.7),0 0 36px rgba(0,200,255,0.3)",
              }}
          ...
          <div style={{ display:"flex", flexDirection:"column", gap:3, minWidth:0 }}>
            <div style={{
              ...
              background:"linear-gradient(90deg,#f59e0b,#00c8ff,#a78bfa)",
              WebkitBackgroundClip:"text", WebkitTextFillColor:"transparent", backgroundClip:"text",
            }}>
              ❤ SUPPORT · DRAGON MONAD
            </div>
            <div style={{ fontSize:10, color:"rgba(224,244,255,0.45)", letterSpacing:2, fontFamily:"'Cinzel',serif" }}>
              DONATE TO KEEP THE DRAGON ALIVE · CLICK TO VIEW ON MONADVISION
            </div>
            <div style={{ fontFamily:"monospace", fontSize:9, color:"rgba(0,200,255,0.55)", letterSpacing:1, marginTop:1 }}>
          ...
          <div style={{
            ...
            fontFamily:"'Cinzel',serif", fontSize:10, color:"#f59e0b",
            ...
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none">
              <path d="M12 21C12 21 3 14.5 3 8.5A5.5 5.5 0 0 1 12 5.1 5.5 5.5 0 0 1 21 8.5C21 14.5 12 21 12 21Z"
                fill="url(#hg)" stroke="#f59e0b" strokeWidth="1.2"/>
              <defs>
                <linearGradient id="hg" x1="0" y1="0" x2="1" y2="1">
                  <stop offset="0%" stopColor="#f59e0b"/><stop offset="100%" stopColor="#ff6b35"/>
                </linearGradient>
              </defs>
            </svg>
            DONATE
        ...
        <div style={{
          ...
          <span style={{ fontFamily:"monospace", fontSize:10, color:"rgba(0,200,255,0.5)", letterSpacing:1 }}>
            CONTRACT: {TOKEN_ADDRESS}
          </span>
          <button onClick={copyAddr} style={{
            padding:"3px 12px", borderRadius:6, cursor:"pointer",
            border:"1px solid rgba(0,200,255,0.35)",
            background: copied ? "rgba(0,200,255,0.2)" : "rgba(0,200,255,0.06)",
            color: copied ? "#00eaff" : "rgba(0,200,255,0.6)",
            ...
            return (
              <a key={i} href={l.href} target="_blank" rel="noopener noreferrer"
                style={{
                  ...
                  flex:1, minWidth:110,
                  borderRight: i < socialLinks.length-1 ? "1px solid rgba(0,200,255,0.08)" : "none",
                  transition:"background 0.2s",
                }}
                onMouseOver={function(e){ e.currentTarget.style.background="rgba(0,200,255,0.06)"; }}
                onMouseOut= {function(e){ e.currentTarget.style.background="transparent"; }}
              >
                <span style={{ lineHeight:1 }}>{l.icon}</span>
                <span style={{
                  fontFamily:"'Cinzel',serif", fontSize:9, fontWeight:700,
                  letterSpacing:2, color:l.color,
                }}>
                  {l.label}
                </span>
                <span style={{ fontSize:8, color:"rgba(224,244,255,0.22)", letterSpacing:1, fontFamily:"'Rajdhani',sans-serif" }}>
                  {l.sub}
                </span>
              </a>
            );
        ...
        <div style={{
          ...
          fontSize:8, color:"rgba(224,244,255,0.15)", letterSpacing:4,
      ...
      <style>{`
        ...
        *,*::before,*::after { box-sizing:border-box; margin:0; padding:0; }
        ...
        .logo-text {
          ...
          letter-spacing:4px; filter:drop-shadow(0 0 10px rgba(0,200,255,0.6));
        }
        ...
        .stat-card {
          background:linear-gradient(135deg,rgba(0,18,48,0.9),rgba(0,10,35,0.95));
        ...
        .card {
          background:linear-gradient(135deg,rgba(0,14,36,0.97),rgba(0,10,35,0.99));
        ...
        .card-title {
          ...
          background:linear-gradient(135deg,#00eaff,#00ffcc);
          -webkit-background-clip:text; -webkit-text-fill-color:transparent; background-clip:text;
        ...
        .field input,.field select { width:100%; padding:11px 14px; border-radius:8px; background:rgba(0,10,35,0.9); border:1px solid var(--border); color:var(--text); font-family:'Rajdhani',sans-serif; font-size:15px; outline:none; transition:border-color .2s,box-shadow .2s; }
        ...
        .btn-neon {
          ...
          border:1px solid rgba(0,200,255,0.5); cursor:pointer;
        ...
        .btn-outline {
          ...
          border:1px solid rgba(0,200,255,0.3); background:transparent; color:var(--text-dim);
